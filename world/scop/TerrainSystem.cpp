...
TerrainSystem::TerrainSystem(EntityRegistry& entity_registry, ChunkRegistry& chunk_registry, ChunkMeshRegistry& chunk_mesh_registry)
	: entity_registry(entity_registry),
	chunk_registry(chunk_registry),
	chunk_mesh_registry(chunk_mesh_registry)
{
	chunk_registry.addCallback(&this->chunk_mesh_registry);
