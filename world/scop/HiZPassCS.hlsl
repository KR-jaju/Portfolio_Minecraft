...
void main(uint3 dispatchID : SV_DispatchThreadID)
{
    ...
    bool isEdgeX = (base_pixel.x + 2 < input_dimension.x && base_pixel.x + 2 == input_dimension.x - 1);
    bool isEdgeY = (base_pixel.y + 2 < input_dimension.y && base_pixel.y + 2 == input_dimension.y - 1);
